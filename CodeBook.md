...
The script assumes the UCI dataset is extracted directly into the ./UCIHarDataset directory. I renamed the expected data directory so that spaces were not in the name and I would not need to escape the spaces.
